  ...
  return (
    <div className="container biography">
      ...
      <div className="banner">
        ...
        <p>
        Our Team:
City Hospital is proud to have a team of experienced and dedicated healthcare professionals, including physicians, nurses, and support staff. Our team works collaboratively to provide comprehensive care, leveraging their expertise and compassion to meet the unique needs of each patient.
        </p>
      </div>
    </div>
  );
