  ...
  return (
    <div className="container biography">
      ...
      <div className="banner">
        ...
        <p>
          <b>Experience the City Hospital Difference:</b> We invite you to experience
          the difference at City Hospital. From routine medical care to
          specialized treatments, we are here to support your health and
